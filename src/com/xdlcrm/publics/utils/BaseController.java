package com.xdlcrm.publics.utils;

import cn.org.farseer.rs.web.util.JackSonUtils;
...
public abstract class BaseController implements InitializingBean {
	...
	protected ThreadLocal<PageBean> pageBeanStore = new ThreadLocal<PageBean>();//PageBean的线程池

	protected PageBean processPageBean(Integer pageSize, Integer currentPage) {
		PageBean pageBean = new PageBean();
		pageBeanStore.set(pageBean);//将生成的pageBean放进线程池中，可以解决并发的问题
